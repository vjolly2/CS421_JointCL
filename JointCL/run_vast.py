...
# Instructor class definition makes use of pretrained BERT model
class Instructor(object):
    ...
    # Load model and return accuracy and classification report, f1 score etc 
    ...
    # Features are computed using this function
